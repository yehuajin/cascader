...
export default {
  ...
  props: {
    ...
    rowSpan: String | Number, // 新增
    colSpan: String | Number, // 新增
    hidden: Boolean, // 新增
    levelNum: String | Number, // 新增
    label: String,
    className: String,
  ...
  created() {
    ...
    const rowSpan = parseWidth(this.rowSpan) // 新增
    const colSpan = parseWidth(this.colSpan) // 新增
    const levelNum = parseWidth(this.levelNum) // 新增
